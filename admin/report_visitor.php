  ...
  <section class="content">
    <div class="container-fluid">
      <div class="invoice p-3">
        ...
        <div>
          <p class="text-center text-bold">VISITORS RECORD</p>
        </div>
        ...
        <div class="table-responsive">
          <table class="table table-bordered compact">
            ...
            <tbody>
              ...
              $query = "SELECT v.*, r.record_date, r.timein, r.timeout 
                  FROM visitors v
                  LEFT JOIN records r ON v.id = r.record_id
                  WHERE r.record_table = 'visitor'";
