...
<script>
    $('.unarchive_vendor').click(function() {

        _conf("Are you sure to unarchive this data?", "unarchive_vendor", [$(this).attr('data-id')])
    });

    function unarchive_vendor($id) {

        start_load();
        $.ajax({
            url: 'ajax.php?action=unarchive_vendor',
            method: 'POST',
            data: {
                id: $id
            },
