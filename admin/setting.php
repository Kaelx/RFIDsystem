                    ...
                    <form action="#" id="profile_update">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        ...
                                        <div class="img-fluid">
                                            <img id="modalImg" src="assets/img/<?php echo !empty($member['img_path']) ? $member['img_path'] : 'blank-img.png'; ?>" alt="Image Preview" class="img-fluid rounded" />
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" class="form-control form-control-sm" name="cellnum" id="cellnum" required value="<?= isset($member['cellnum']) ? $member['cellnum'] : '' ?>" required oninput="this.value = this.value.slice(0, 11);" pattern="\d{11}" title="Please enter exactly 11 digits">
                            </div>
