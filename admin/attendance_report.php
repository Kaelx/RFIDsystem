        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <a href="?p=report_adminstaff&employee_type=1" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
                            <span class="info-box-icon bg-info"><i class="fa-solid fa-user-tie"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text">Administrative Staff</span>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <a href="?p=report_designatedstaff&employee_type=2" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
                            <span class="info-box-icon bg-success"><i class="fa-solid fa-user-tie"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text">Designated Faculty</span>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <a href="?p=report_faculty&employee_type=3" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
                            <span class="info-box-icon bg-primary"><i class="fa-solid fa-user-tie"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text">Teachers/Intructor</span>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <a href="?p=report_cos&employee_type=4" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <a href="?p=report_visitor" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
