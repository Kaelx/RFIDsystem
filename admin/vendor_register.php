...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header text-bold text-center">Register Vendor</div>
                <div class="card-body">
                    <form action="#" id="register">
                        ...
                        <p class="text-bold text-red"><i>Vendor Information *</i></p>
                        <div class="row">
                        ...
                        <div class="row">
                            <?php
                            $type = $conn->query("SELECT * FROM role WHERE id = 4 ORDER BY id ASC");
                        ...
                        <div class="text-center">
                            ...
                            <a href="index.php?page=vendor_data" class="btn btn-secondary btn-custom">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
