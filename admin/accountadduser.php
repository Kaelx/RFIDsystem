                    ...
                    <form action="#" id="register">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" class="form-control form-control-sm" name="cellnum" id="cellnum" required oninput="this.value = this.value.slice(0, 11);" pattern="\d{11}" title="Please enter exactly 11 digits">
                            </div>
