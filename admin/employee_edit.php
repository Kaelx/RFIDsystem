                    ...
                    <form action="#" id="register">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select class="form-control  select2" name="dept_id" id="dept_id">
                                    <option value="" <?= !empty($data['dept_id']) || $data['dept_id'] == '0' || $data['dept_id'] == '' ? 'selected' : '' ?>>-- select --</option>
                                    <?php
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <a href="?p=employee_view&uid=<?= $data['id'] ?>" class="btn btn-danger btn-custom">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp == 1) {
                    ...
                    setTimeout(function() {
                        location.href = '?p=employee_view&uid=' + <?= $data['id'] ?>
                    }, 1000)
