        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    ...
                    $count = $qry->num_rows;
                    ?>
                    <a href="?p=archived_employees" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    ...
                    $count = $qry->num_rows;
                    ?>
                    <a href="?p=archived_students" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    ...
                    $count = $qry->num_rows;
                    ?>
                    <a href="?p=archived_vendors" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    ...
                    $count = $qry->num_rows;
                    ?>
                    <a href="?p=archived_visitors" style="text-decoration: none; color: inherit;">
                        <div class="info-box">
